...
def create_category(category: schemas.CategoryCreate, user_id: str, db: Session = Depends(get_db)):
...
def read_categories(user_id: str, skip: int = 0, limit: int = 100, db: Session = Depends(get_db)):
